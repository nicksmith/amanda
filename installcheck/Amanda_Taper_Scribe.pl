...
sub request_volume_permission {
    ...
    Amanda::MainLoop::call_later($params{'perm_cb'}, $answer);
}
...
sub run_devh {
	...
	Amanda::MainLoop::call_later($get_volume);
    };
...
is_deeply([ @events ], [
      ...
      [ 'notif_dump_done', 'DONE', [], [], bi(307200) ],
      [ 'dump_cb', undef ],
...
is_deeply([ @events ], [
      ...
      [ 'notif_dump_done', 'DONE', [], [], bi(655360) ],
      [ 'dump_cb', undef ]
...
is_deeply([ @events ], [
      ...
      [ 'notif_dump_done', 'PARTIAL', [], [$experr], bi(393216) ],
      [ 'dump_cb', $experr ]
...
is_deeply([ @events ], [
      ...
      [ 'notif_dump_done', 'PARTIAL', [], ["Cannot use new volume: sorry!"], bi(393216) ],
      [ 'dump_cb', "Cannot use new volume: sorry!" ]
